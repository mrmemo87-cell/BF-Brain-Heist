...
import type { PvETier } from '@/lib/types';
...
const PvePage: React.FC = () => {
    ...
    const tasks = [
        { tier: 'easy' as PvETier, title: 'Data Intercept', ap: 2, rewards: 'Low', glow: 'primary' as const },
        { tier: 'standard' as PvETier, title: 'Node Crack', ap: 3, rewards: 'Medium', glow: 'primary' as const },
        { tier: 'hard' as PvETier, title: 'Mainframe Assault', ap: 4, rewards: 'High', glow: 'accent' as const },
    ];
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="p-4 text-center rounded-lg bg-primary/20 border border-primary/50">
                <p className="font-bold text-primary">Today’s 3 Ops +10% XP</p>
            </div>
                ...
                {tasks.map(task => (
                    ...
                    >
                        <div className="space-y-4 text-center">
                            ...
                            <Button
                                className="w-full"
                                onClick={() => pveRunMutation.mutate(task.tier)}
